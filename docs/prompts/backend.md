...
- GitHub issue: `#32`
- Scope: build the first Apple-first ChatGPT app slice on top of a small CalSync-owned service for conversational calendar write-back
...
- issue `#32` builds on the write-capable foundation from issues `#17`, `#23`, and `#31`
